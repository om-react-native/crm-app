...
export default function UserSettingsScreen() {
  ...
  const [myCustomers] = useState<Customer[]>([
    ...
    { id: '2', name: 'TechChem Industries', type: 'Reseller', status: 'Active' },
  ]);
              ...
              <View key={customer.id} style={styles.customerCard}>
                <View style={styles.customerInfo}>
                  ...
                  <View style={styles.customerMeta}>
                    <View style={[
                      styles.typeBadge,
                      customer.type === 'End User' ? styles.endUserBadge : styles.resellerBadge
                    ]}>
                      <Text style={[
                        styles.typeBadgeText,
                        customer.type === 'End User' ? styles.endUserText : styles.resellerText
                      ]}>{customer.type}</Text>
                    </View>
                  </View>
                </View>
