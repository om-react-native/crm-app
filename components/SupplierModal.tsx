...
import { X, Mail, Pencil, ChevronDown, ChevronUp, Upload, File, Trash2 } from 'lucide-react-native';
...
export default function SupplierModal({ visible, onClose, supplier }: SupplierModalProps) {
  ...
  const handleSaveName = () => {
    ...
    // Here you would typically update the supplier name in your data store
  };
          ...
          <View style={styles.modalHeader}>
            <View style={styles.titleContainer}>
              {isEditingName ? (
                ...
                <>
                  <Text style={styles.modalTitle}>{supplierName}</Text>
              ...
              <View style={styles.expandedContent}>
                <View style={styles.checkboxContainer}>
                  ...
                  >
                    ...
                    <Text style={styles.checkboxText}>Verified</Text>
                  </TouchableOpacity>
                  <TouchableOpacity 
                    style={styles.checkboxRow}
